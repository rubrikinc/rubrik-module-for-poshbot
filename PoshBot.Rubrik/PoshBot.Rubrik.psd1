#
# Module manifest for module 'PoshBot.Rubrik'
#
...
RequiredModules = @('Rubrik', 'PoshBot')
...
FunctionsToExport = @(  'Get-PBRubrikDatabase',
                        'Get-PBRubrikReport',
                        'Get-PBRubrikSLA',
                        'Get-PBRubrikSnapshot',
                        'Get-PBRubrikVersion',
                        'Get-PBRubrikVM',
                        'Invoke-PBRubrikHello',
                        'New-PBRubrikFullMount',
                        'Restore-PBRubrikFile',
                        'Set-PBRubrikMount'
                    )
